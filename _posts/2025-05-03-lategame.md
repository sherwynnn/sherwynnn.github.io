...
Each stock that is monitored by the system has its dedicated page with the relevant information and scores that are derived through an in-house risk analysis algorithm, which currently exists as a prototype. 

As much as possible, the page aims to deliver both quantitative and qualitative insights in a refined layout that is easy to digest, providing comprehensive information such as performance ratios, historical charts and news articles that pertain to the stock in question. 
